...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(	WS_EX_APPWINDOW,
							szAppName,
							TEXT("Vulkan| 04-Rectangle-01-BW-Rectangle-02-Triangle-Fan-Way"),
...
VkResult createPipeline(void)
{
	...
	vkPipelineInputAssemblyStateCreateInfo.topology = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_FAN; 		//topology type
...
VkResult buildCommandBuffers(void)
{
	...
	for(uint32_t i = 0; i < swapchainImageCount; i++)
	{
		...
		//draw call
		vkCmdDraw(vkCommandBuffer_array[i], 4, 1, 0, 0); //draw call
