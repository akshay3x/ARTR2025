...
const char *gpszfileName = "VulkanApp";
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	wsprintf(szAppName, TEXT("%s"), gpszfileName);
...
VkResult initialize(void)
{
	...
	if(vkResult != VK_SUCCESS)
	{	
		fprintf(gpFile, "\nDEBUG:[initialize][ERROR] Failed fillInstanceExtensionNames()");
		return vkResult;
	}
	else
...
void uninitialize(void)
{
	...
	if(gpFile)
	{
		fprintf(gpFile, "\nDEBUG:[uninitialize] Log File Closing");
